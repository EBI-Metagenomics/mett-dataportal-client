...
class GenomePaginatedResponseSchema(BaseModel):
    ...
    """ # noqa: E501
    status: Optional[ResponseStatus] = Field(default=None, description="Response status")
    ...
    __properties: ClassVar[List[str]] = ["status", "message", "timestamp", "data", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [GenomeResponseSchema.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
