...
class PaginatedStrainDrugMetabolismResponseSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["isolate_name", "species_acronym", "species_scientific_name", "drug_metabolism_data", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pagination": PaginationMetadataSchema.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj
