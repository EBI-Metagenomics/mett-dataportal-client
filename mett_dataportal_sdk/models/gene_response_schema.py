...
class GeneResponseSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["locus_tag", "gene_name", "alias", "product", "product_source", "start_position", "end_position", "seq_id", "isolate_name", "species_scientific_name", "species_acronym", "uniprot_id", "essentiality", "cog_funcats", "cog_id", "kegg", "pfam", "interpro", "ec_number", "dbxref", "eggnog", "inference", "ontology_terms", "uf_ontology_terms", "uf_prot_rec_fullname", "uf_keyword", "uf_gene_name", "amr", "has_amr_info", "has_proteomics", "has_fitness", "has_mutant_growth", "has_reactions", "feature_type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.uf_ontology_terms is None and "uf_ontology_terms" in self.model_fields_set:
            _dict['uf_ontology_terms'] = None

        # set to None if uf_prot_rec_fullname (nullable) is None
        # and model_fields_set contains the field
        if self.uf_prot_rec_fullname is None and "uf_prot_rec_fullname" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.has_mutant_growth is None and "has_mutant_growth" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dbxref": [DBXRefSchema.from_dict(_item) for _item in obj["dbxref"]] if obj.get("dbxref") is not None else None,
            ...
            "amr": [AMRSchema.from_dict(_item) for _item in obj["amr"]] if obj.get("amr") is not None else None,
