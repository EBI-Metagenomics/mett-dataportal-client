...
class PPINetworkQuerySchema(BaseModel):
    ...
    include_properties: Optional[StrictBool] = Field(default=False, description="Whether to include network properties")
    __properties: ClassVar[List[str]] = ["score_threshold", "species_acronym", "include_properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "score_threshold": obj.get("score_threshold") if obj.get("score_threshold") is not None else 0.8,
            "species_acronym": obj.get("species_acronym"),
            "include_properties": obj.get("include_properties") if obj.get("include_properties") is not None else False
        })
        return _obj
