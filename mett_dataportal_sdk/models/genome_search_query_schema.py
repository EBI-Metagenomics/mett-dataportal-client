...
class GenomeSearchQuerySchema(BaseModel):
    ...
    """ # noqa: E501
    query: Optional[StrictStr] = Field(default='', description="Search term to match against genome names or metadata.")
    page: Optional[StrictInt] = Field(default=1, description="Page number to retrieve.")
    per_page: Optional[StrictInt] = Field(default=20, description="Number of genomes to return per page.")
    ...
    __properties: ClassVar[List[str]] = ["query", "page", "per_page", "sortField", "sortOrder", "isolates", "species_acronym"]
