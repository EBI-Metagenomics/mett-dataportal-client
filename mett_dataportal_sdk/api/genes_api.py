...
class GenesApi:
    ...
    def dataportal_api_core_gene_endpoints_get_gene_by_locus_tag(
        self,
        locus_tag: Annotated[StrictStr, Field(description="Unique locus tag identifier for the gene (e.g., 'ABC_123').")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._dataportal_api_core_gene_endpoints_get_gene_by_locus_tag_serialize(
            locus_tag=locus_tag,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def dataportal_api_core_gene_endpoints_search_genes_by_multiple_genomes_and_species_and_string(
        self,
        isolates: Annotated[Optional[StrictStr], Field(description="Comma-separated list of isolate names to filter.")] = None,
        species_acronym: Annotated[Optional[StrictStr], Field(description="Species acronym to filter (e.g., 'BU', 'PV').")] = None,
        locus_tag: Annotated[Optional[StrictStr], Field(description="Exact locus tag to search for (takes precedence over query if provided).")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Free-text search string for gene names, locus tags, or annotations.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Additional gene filter, e.g., 'pfam:PF07715;interpro:IPR012910'.")] = None,
        filter_operators: Annotated[Optional[StrictStr], Field(description="Logical operators for filters, e.g., 'pfam:AND;interpro:OR'.")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Page number for pagination (1-based).")] = None,
        per_page: Annotated[Optional[StrictInt], Field(description="Number of genes to return per page.")] = None,
        sort_field: Annotated[Optional[StrictStr], Field(description="Field to sort results by, e.g., 'gene_name', 'isolate_name'.")] = None,
        sort_order: Annotated[Optional[StrictStr], Field(description="Sort order: 'asc' or 'desc'.")] = None,
        seq_id: Annotated[Optional[StrictStr], Field(description="Sequence ID (contig/chromosome) to filter genes by coordinate range.")] = None,
        start_position: Annotated[Optional[StrictInt], Field(description="Start position for coordinate range filtering.")] = None,
        end_position: Annotated[Optional[StrictInt], Field(description="End position for coordinate range filtering.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def dataportal_api_core_gene_endpoints_search_genes_by_string(
        self,
        query: Annotated[Optional[StrictStr], Field(description="Free-text search term to match against gene names or locus tags.")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Page number for pagination (1-based).")] = None,
        per_page: Annotated[Optional[StrictInt], Field(description="Number of genes to return per page.")] = None,
        sort_field: Annotated[Optional[StrictStr], Field(description="Field to sort results by (e.g., 'gene_name', 'isolate_name').")] = None,
        sort_order: Annotated[Optional[StrictStr], Field(description="Sort order: 'asc' or 'desc'.")] = None,
        ...
        _param = self._dataportal_api_core_gene_endpoints_search_genes_by_string_serialize(
            query=query,
            page=page,
            per_page=per_page,
            sort_field=sort_field,
    ...
    def dataportal_api_experimental_essentiality_endpoints_get_essentiality_by_gene(
        self,
        locus_tag: Annotated[StrictStr, Field(description="Gene locus tag or UniProt ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def dataportal_api_experimental_proteomics_endpoints_get_proteomics_by_gene(
        self,
        locus_tag: Annotated[StrictStr, Field(description="Gene locus tag or UniProt ID (e.g., 'BU_ATCC8492_00001')")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def dataportal_api_interactions_fitness_correlation_endpoints_get_gene_correlations(
        ...
        min_correlation: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Minimum absolute correlation value")] = None,
    ...
    def dataportal_api_interactions_operon_endpoints_get_gene_operons(
        self,
        locus_tag: StrictStr,
        species_acronym: Annotated[Optional[StrictStr], Field(description="Filter by species")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def dataportal_api_interactions_ortholog_endpoints_get_gene_orthologs(
        self,
        locus_tag: StrictStr,
        species_acronym: Annotated[Optional[StrictStr], Field(description="Filter by target species")] = None,
        orthology_type: Annotated[Optional[StrictStr], Field(description="Filter by orthology type (1:1, many:1, etc.)")] = None,
        one_to_one_only: Annotated[Optional[StrictBool], Field(description="Return only one-to-one orthologs")] = None,
        cross_species_only: Annotated[Optional[StrictBool], Field(description="Return only cross-species orthologs")] = None,
        max_results: Annotated[Optional[Annotated[int, Field(le=100000, strict=True)]], Field(description="Maximum number of results to return")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
